    ...
    <section className="screen screen--alert">
      ...
      <section className="responders">
        <div className="sectionlabel">
          ...
          <small className="num">{Math.round(minutes)} min de ocorrência</small>
        </div>
        {incident.dispatches.length === 0 ? (
          ...
          <ul>
            {incident.dispatches.map((item) => {
              ...
              return (
                <li key={item.unitId}>
                  <span className={`responders__icon${done ? " is-done" : ""}`}>
                  ...
                  <span className={`responders__eta num${done ? " is-done" : ""}`}>
        ...
        <button
          ...
          onClick={() => {
            ...
            onToast({
              ...
              detail: "A Central deixa de contar você entre as pessoas em risco.",
            });
          }}
        >
